...
void read_ultrasonic_sensor(void)
{
  ...
  if(UltrasonicSensorData[0]==0){UltrasonicSensorData[0]=MAX_DISTANCE*10;}
  if(UltrasonicSensorData[1]==0){UltrasonicSensorData[1]=MAX_DISTANCE*10;}
  if(UltrasonicSensorData[2]==0){UltrasonicSensorData[2]=MAX_DISTANCE*10;}
}
...
void wall_following()
{
  ...
  else if(UltrasonicSensorData[2] > UltrasonicSensorData[0])
  {
...
void loop() 
{
  ...
  if(UltrasonicSensorData[1] <=1000)
  {
    count++;
  }
  else
